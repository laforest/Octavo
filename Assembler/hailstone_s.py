...
bench_dir  = "Hailstone_S"
bench_file = "hailstone_s"
...
def assemble_I(PC, A, B):
    ...
    I.I(MLS, "temp", "three", "temp"),                  I.JEV("even", False, "jmp1")
    I.I(ADD, "temp", "one", "temp")
    I.I(MHU, "seed_pointer", "right_shift_1", "temp"),  I.N("even"), I.JMP("hailstone", "jmp2")
