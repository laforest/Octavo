...
bench_dir  = "Array_Reverse_3"
bench_file = "array_reverse_3"
...
def assemble_I(PC, A, B):
    ...
    # Do the 3-swap
    I.I(ADD, "temp",    0, "array_top_pointer"),            I.N("next")
    I.I(ADD, "array_top_pointer", 0, "array_bottom_pointer")
    I.I(ADD, "array_bottom_pointer", 0, "temp")
