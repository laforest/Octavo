...
condition   jmp     a_negative  b_lessthan  always_one  # Jump always
condition   bsa     a_sentinel  b_lessthan  a           # Jump on Branch Sentinel A match
condition   ctz     a_negative  b_counter   not_b       # Jump on Counter reaching Zero (not running)
