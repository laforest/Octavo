...
mem_map = {
    ...
    # High memory is write only. Place controls there.
    ...
    "DPO":  {"Origin":3080, "Depth":16, "bit_offset":20},
    "APO":  {"Origin":3080, "Depth":16, "bit_offset":10},
    "BPO":  {"Origin":3080, "Depth":16, "bit_offset":0},
    # Increments, alongside in same words at operand positions, but shifted above PO
    "DIN":  {"Origin":3080, "Depth":16, "bit_offset":34},
    "AIN":  {"Origin":3080, "Depth":16, "bit_offset":33},
    "BIN":  {"Origin":3080, "Depth":16, "bit_offset":32},
