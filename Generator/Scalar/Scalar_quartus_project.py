...
set_global_assignment -name VERILOG_FILE ${install_base}/Octavo/Memory/Port_Active.v
set_global_assignment -name VERILOG_FILE ${install_base}/Octavo/Memory/IO_Active.v
set_global_assignment -name VERILOG_FILE ${install_base}/Octavo/Memory/IO_All_Ready.v
set_global_assignment -name VERILOG_FILE ${install_base}/Octavo/Memory/IO_Check.v
set_global_assignment -name VERILOG_FILE ${install_base}/Octavo/Memory/IO_Read.v
set_global_assignment -name VERILOG_FILE ${install_base}/Octavo/Memory/IO_Write.v
