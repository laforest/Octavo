...
set_global_assignment -name VERILOG_FILE ${install_base}/Octavo/Addressing/Thread_Value.v
set_global_assignment -name VERILOG_FILE ${install_base}/Octavo/Addressing/Offset_Selector.v
