...
#(
    ...
    parameter       A_DEFAULT_OFFSET_RAMTYLE            = ${A_DEFAULT_OFFSET_RAMTYLE},
    ...
    parameter       B_DEFAULT_OFFSET_RAMTYLE            = ${B_DEFAULT_OFFSET_RAMTYLE},
    ...
    parameter       D_DEFAULT_OFFSET_RAMTYLE            = ${D_DEFAULT_OFFSET_RAMTYLE},
