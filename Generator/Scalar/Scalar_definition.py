...
// -----------------------------------------------------------
    ...
    parameter   A_BASIC_BLOCK_COUNTER_WRITE_WORD_OFFSET     = ${A_BASIC_BLOCK_COUNTER_WRITE_WORD_OFFSET},
    parameter   A_BASIC_BLOCK_COUNTER_WRITE_ADDR_OFFSET     = ${A_BASIC_BLOCK_COUNTER_WRITE_ADDR_OFFSET},
    parameter   A_BASIC_BLOCK_COUNTER_WORD_WIDTH            = ${A_BASIC_BLOCK_COUNTER_WORD_WIDTH},
    parameter   A_BASIC_BLOCK_COUNTER_ADDR_WIDTH            = ${A_BASIC_BLOCK_COUNTER_ADDR_WIDTH},
    parameter   A_BASIC_BLOCK_COUNTER_DEPTH                 = ${A_BASIC_BLOCK_COUNTER_DEPTH},
    parameter   A_BASIC_BLOCK_COUNTER_RAMSTYLE              = ${A_BASIC_BLOCK_COUNTER_RAMSTYLE},
    parameter   A_BASIC_BLOCK_COUNTER_INIT_FILE             = ${A_BASIC_BLOCK_COUNTER_INIT_FILE},

    parameter   A_CONTROL_MEMORY_WRITE_WORD_OFFSET          = ${A_CONTROL_MEMORY_WRITE_WORD_OFFSET},
    parameter   A_CONTROL_MEMORY_WRITE_ADDR_OFFSET          = ${A_CONTROL_MEMORY_WRITE_ADDR_OFFSET},
    parameter   A_CONTROL_MEMORY_WORD_WIDTH                 = ${A_CONTROL_MEMORY_WORD_WIDTH},
    parameter   A_CONTROL_MEMORY_ADDR_WIDTH                 = ${A_CONTROL_MEMORY_ADDR_WIDTH},
    parameter   A_CONTROL_MEMORY_DEPTH                      = ${A_CONTROL_MEMORY_DEPTH},
    parameter   A_CONTROL_MEMORY_RAMSTYLE                   = ${A_CONTROL_MEMORY_RAMSTYLE},
    parameter   A_CONTROL_MEMORY_INIT_FILE                  = ${A_CONTROL_MEMORY_INIT_FILE},
    parameter   A_CONTROL_MEMORY_MATCH_WIDTH                = ${A_CONTROL_MEMORY_MATCH_WIDTH},
    parameter   A_CONTROL_MEMORY_COND_WIDTH                 = ${A_CONTROL_MEMORY_COND_WIDTH},
    parameter   A_CONTROL_MEMORY_LINK_WIDTH                 = ${A_CONTROL_MEMORY_LINK_WIDTH},
...
// -----------------------------------------------------------
    ...
    parameter   B_BASIC_BLOCK_COUNTER_WRITE_WORD_OFFSET     = ${B_BASIC_BLOCK_COUNTER_WRITE_WORD_OFFSET},
    parameter   B_BASIC_BLOCK_COUNTER_WRITE_ADDR_OFFSET     = ${B_BASIC_BLOCK_COUNTER_WRITE_ADDR_OFFSET},
    parameter   B_BASIC_BLOCK_COUNTER_WORD_WIDTH            = ${B_BASIC_BLOCK_COUNTER_WORD_WIDTH},
    parameter   B_BASIC_BLOCK_COUNTER_ADDR_WIDTH            = ${B_BASIC_BLOCK_COUNTER_ADDR_WIDTH},
    parameter   B_BASIC_BLOCK_COUNTER_DEPTH                 = ${B_BASIC_BLOCK_COUNTER_DEPTH},
    parameter   B_BASIC_BLOCK_COUNTER_RAMSTYLE              = ${B_BASIC_BLOCK_COUNTER_RAMSTYLE},
    parameter   B_BASIC_BLOCK_COUNTER_INIT_FILE             = ${B_BASIC_BLOCK_COUNTER_INIT_FILE},

    parameter   B_CONTROL_MEMORY_WRITE_WORD_OFFSET          = ${B_CONTROL_MEMORY_WRITE_WORD_OFFSET},
    parameter   B_CONTROL_MEMORY_WRITE_ADDR_OFFSET          = ${B_CONTROL_MEMORY_WRITE_ADDR_OFFSET},
    parameter   B_CONTROL_MEMORY_WORD_WIDTH                 = ${B_CONTROL_MEMORY_WORD_WIDTH},
    parameter   B_CONTROL_MEMORY_ADDR_WIDTH                 = ${B_CONTROL_MEMORY_ADDR_WIDTH},
    parameter   B_CONTROL_MEMORY_DEPTH                      = ${B_CONTROL_MEMORY_DEPTH},
    parameter   B_CONTROL_MEMORY_RAMSTYLE                   = ${B_CONTROL_MEMORY_RAMSTYLE},
    parameter   B_CONTROL_MEMORY_INIT_FILE                  = ${B_CONTROL_MEMORY_INIT_FILE},
    parameter   B_CONTROL_MEMORY_MATCH_WIDTH                = ${B_CONTROL_MEMORY_MATCH_WIDTH},
    parameter   B_CONTROL_MEMORY_COND_WIDTH                 = ${B_CONTROL_MEMORY_COND_WIDTH},
    parameter   B_CONTROL_MEMORY_LINK_WIDTH                 = ${B_CONTROL_MEMORY_LINK_WIDTH},
...
// -----------------------------------------------------------
    ...
    parameter   D_BASIC_BLOCK_COUNTER_WRITE_WORD_OFFSET     = ${D_BASIC_BLOCK_COUNTER_WRITE_WORD_OFFSET},
    parameter   D_BASIC_BLOCK_COUNTER_WRITE_ADDR_OFFSET     = ${D_BASIC_BLOCK_COUNTER_WRITE_ADDR_OFFSET},
    parameter   D_BASIC_BLOCK_COUNTER_WORD_WIDTH            = ${D_BASIC_BLOCK_COUNTER_WORD_WIDTH},
    parameter   D_BASIC_BLOCK_COUNTER_ADDR_WIDTH            = ${D_BASIC_BLOCK_COUNTER_ADDR_WIDTH},
    parameter   D_BASIC_BLOCK_COUNTER_DEPTH                 = ${D_BASIC_BLOCK_COUNTER_DEPTH},
    parameter   D_BASIC_BLOCK_COUNTER_RAMSTYLE              = ${D_BASIC_BLOCK_COUNTER_RAMSTYLE},
    parameter   D_BASIC_BLOCK_COUNTER_INIT_FILE             = ${D_BASIC_BLOCK_COUNTER_INIT_FILE},

    parameter   D_CONTROL_MEMORY_WRITE_WORD_OFFSET          = ${D_CONTROL_MEMORY_WRITE_WORD_OFFSET},
    parameter   D_CONTROL_MEMORY_WRITE_ADDR_OFFSET          = ${D_CONTROL_MEMORY_WRITE_ADDR_OFFSET},
    parameter   D_CONTROL_MEMORY_WORD_WIDTH                 = ${D_CONTROL_MEMORY_WORD_WIDTH},
    parameter   D_CONTROL_MEMORY_ADDR_WIDTH                 = ${D_CONTROL_MEMORY_ADDR_WIDTH},
    parameter   D_CONTROL_MEMORY_DEPTH                      = ${D_CONTROL_MEMORY_DEPTH},
    parameter   D_CONTROL_MEMORY_RAMSTYLE                   = ${D_CONTROL_MEMORY_RAMSTYLE},
    parameter   D_CONTROL_MEMORY_INIT_FILE                  = ${D_CONTROL_MEMORY_INIT_FILE},
    parameter   D_CONTROL_MEMORY_MATCH_WIDTH                = ${D_CONTROL_MEMORY_MATCH_WIDTH},
    parameter   D_CONTROL_MEMORY_COND_WIDTH                 = ${D_CONTROL_MEMORY_COND_WIDTH},
    parameter   D_CONTROL_MEMORY_LINK_WIDTH                 = ${D_CONTROL_MEMORY_LINK_WIDTH},
